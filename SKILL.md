...
- **输出**：保存清洗后的图片到 `outputs/xiaohongshu-automation-pipeline-skill/yyyymmdd-[project-name]/cover.png`。
...
- **执行**：`./.venv/bin/python .gemini/skills/obsidian-archiver-skill/scripts/archive.py --title "placeholder" --type "Xiaohongshu" --content_file "outputs/xiaohongshu-automation-pipeline-skill/yyyymmdd-[project-name]/01-polished.md"`
- **默认行为**：跳过。
